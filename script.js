const questions = [
    ...
    { question: "What is the role of AMP-activated protein kinase (AMPK) in myocardial metabolism?", options: ["Inhibits fatty acid oxidation", "Activates fatty acid oxidation", "Inhibits glucose oxidation", "Enhances lactate accumulation"], answer: "Activates fatty acid oxidation" },
    { question: "Which biomarker remains elevated for the longest period after myocardial infarction (MI)?", options: ["Myoglobin", "Creatine kinase-MB (CK-MB)", "Troponin I", "Lactate dehydrogenase (LDH)"], answer: "Troponin I" },
    { question: "Which enzyme is commonly used along with CK-MB to diagnose acute myocardial infarction?", options: ["AST", "LDH", "Both A and B", "None of the above"], answer: "Both A and B" },
    { question: "Which condition is associated with increased BNP levels?", options: ["Myocardial infarction", "Heart failure", "Hypertension", "Aortic stenosis"], answer: "Heart failure" },
    { question: "Which biomarker is used for diagnosing thromboembolic disease?", options: ["Troponin I", "CK-MB", "D-dimer", "BNP"], answer: "D-dimer" }
];
